...
const AddUser = ({
  ...
  return <Modal show={isOpen} onHide={toggleModal}>
    <Modal.Header closeButton>Add Player</Modal.Header>
    <Modal.Body>
    ...
    <Modal.Footer>
      ...
      <button type="button" className="btn float-right ml-2" onClick={() => onCancelPlayer()}>Cancel</button>
    </Modal.Footer>
  </Modal>
}
